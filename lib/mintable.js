 ...
 * idiom above.
 */
const configRoot = dirname(module.parent.filename)
...
function callerMayAccessMint (concreteType) {
  ...
  // TODO: make sure we're resistant to Function monkeypatching
...
function getCallerModuleName () {
  ...
  // TODO: if there is a node_modules path at the start, strip off
  // everything past [@scope/][modulename]
  return relModule
}
